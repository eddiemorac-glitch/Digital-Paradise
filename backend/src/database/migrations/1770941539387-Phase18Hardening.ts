...
export class Phase18Hardening1770941539387 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_54cf80d17d0fc4777d3c46f76b" ON "webhook_logs" ("provider") `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_4c1989542e47d9e3b98fe32c67" ON "sessions" ("expiredAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_4b2bf18167e94dce386d714c67" ON "users" ("fullName") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_ace513fa30d485cfd25c11a9e4" ON "users" ("role") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_1e3d0240b49c40521aaeb95329" ON "users" ("phoneNumber") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_409a0298fdd86a6495e23c25c6" ON "users" ("isActive") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_c1ead5676ec405db6f946817da" ON "users" ("courierStatus") `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_c3932231d2385ac248d0888d95" ON "products" ("category") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_561285a7c09aa749e7da74706c" ON "products" ("cabysCode") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_7139c20741319eaa68e7fac20e" ON "products" ("merchantId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_f125672f13f9d234c6696db220" ON "merchants" ("name") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_7f84b6e8b5c5b767641f12fc43" ON "merchants" ("category") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_84f1d5ba14e3d8ec381d885248" ON "merchants" ("status") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_d930f10be0b46fea25d93d2bca" ON "merchants" ("isActive") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_b1c476d3c6903e4db115bc649d" ON "merchants" ("isSustainable") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_7e04c437e9e88358af2340dae8" ON "logistics_missions" ("status") `);
    }
